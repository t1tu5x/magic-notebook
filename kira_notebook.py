...
st.set_page_config(page_title="פנקס קירה 🐱", layout="centered")
...
st.markdown("""
    ...
    <div style='text-align: center;'>
        <img src='https://media.tenor.com/WXBzKQfi9g4AAAAi/cat-kitty.gif' class='kawaii-cat'>
        <div style='font-size: 30px; color: deeppink; font-weight: bold;'>🐾 יומן הקסמים של קירה 🐾</div>
        <div style='font-size: 18px; color: #cc00cc;'>חתולה חכמה יודעת לנהל כסף 💰</div>
    </div>
...
if st.button("🎉 כמה ימים עד יום ההולדת שלי?"):
    ...
    st.info(f"נותרו {days_left} ימים ליום ההולדת שלך, חתולה! 🎂🎀")
